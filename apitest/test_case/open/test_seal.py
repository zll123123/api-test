...
class Test_seal:
    @pytest.mark.parametrize(
        ...
        parse_csv(
            read_case_yaml(
                os.path.join(rootpath, "test_data/open/seal/company_seal_create.yaml")
            )
        ),
    )
    ...
    @pytest.mark.parametrize(
        ...
        parse_csv(
            read_case_yaml(
                os.path.join(rootpath, "test_data/open/seal/seal_create_auto.yaml")
            )
        ),
    )
    ...
    @pytest.mark.parametrize(
        "new_case_info",
        parse_csv(
            read_case_yaml(os.path.join(rootpath, "test_data/open/seal/seal_list.yaml"))
        ),
    )
    ...
    @pytest.mark.parametrize(
        ...
        parse_csv(
            read_case_yaml(
                os.path.join(rootpath, "test_data/open/seal/seal_status.yaml")
            )
        ),
    )
